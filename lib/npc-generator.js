...
function addBarbarian(character) {
  const char = character;
  char.hitDice = 12;
  char.primaryMelee = 'str';
  char.primarySpell = null;
  char.saveProf = ['str', 'con'];
  char.armorProf = ['light armor', 'medium armor', 'shields'];
  char.weaponProf = ['simple weapons', 'martial weapons'];
  char.toolProf = null;
}

function addBard(character) {
  const char = character;
  char.hitDice = 8;
  char.primaryMelee = 'dex';
  char.primarySpell = 'cha';
  char.saveProf = ['dex', 'cha'];
  ...
  char.toolProf = 'three musical instruments of your choice';
}
